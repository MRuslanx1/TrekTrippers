...
def saveTrip(request):
    ...
    if form.is_valid():
        ...
        try:
            ...
            # Alert to user to enter a valid city and country name
            error_message = "Please enter a valid city and country name."
            # Render the same page with the error message
            return render(request, 'planner/error.html', {'error_message': error_message})
        ...
        # Form is not valid, handle the case appropriately
